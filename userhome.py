...
class MainWindow1(QMainWindow):
    def __init__(self,uid):
        ...
        sImage = oImage.scaled(QSize(1400,900))
        palette = QPalette()
        ...
        self.l6.move(300, 100)
        self.l15 = QLabel("skeleton", self)
        self.l15.move(480, 100)

        self.i1 = QLabel("Choose Iris", self)
        # self.l2.setGeometry(400,50,200, 30)
        self.i1.move(280, 240)
        self.i2 = QLineEdit(" ", self)
        self.i2.setGeometry(400, 50, 170, 30)
        self.i2.move(400, 240)
        self.i3 = QPushButton("Browse..", self)
        self.i3.move(580, 240)
        self.i3.clicked.connect(self.clkr)

        self.i4 = QLabel("Iris image", self)
        self.i4.move(300, 300)
        self.i5 = QLabel("", self)
        self.i5.move(480, 300)
        ...
        self.l24.move(900+dd, 370)
        self.l25 = QTextEdit(" ", self)
        self.l25.setGeometry(800+dd, 400, 350, 300)

        self.l22 = QLabel("Message", self)
        self.l22.move(900+dd, 725)
        self.l23 = QLineEdit(" ", self)
        self.l23.setGeometry(800+dd, 760, 350, 60)
        self.l20 = QPushButton("send", self)
        self.l20.clicked.connect(self.sendmsg)
        self.l20.move(1160+dd,790)
    ...
    def split_codes(codes, masks, targets):
        ...
        return np.vstack(X_base), np.vstack(M_base), np.array(y_base), np.array(X_test), np.array(M_test), np.array(
            y_test)
    ...
    def clkr(self):
        ...
        with open(self.app1[0], 'r') as file_header:
            if self.app1[0] == "":
                ...
                aa = self.pixmap.scaled(120, 120)
                # self.l6.move(290, 130)
                self.i4.resize(120, 120)
                self.i4.setPixmap(aa)
                self.q = QImage(self.app1[0])
                self.i2.setText(self.app1[0])

                image = cv2.imread(self.app1[0])
                ...
                print("------------------------------------------------------")
                i = 0
                # wmg = WeightedMinHashGenerator(len(code[0]))
                ...
                for p in data:
                    # random permutations
                    x1 = np.random.permutation(p)
                    x2 = np.random.permutation(p)
                    print(str(x1))
                    print(str(x2))

                    # hadamard product...
                    xx = np.multiply(x1, x2)
                    print(str(xx))
                ...
                print(chash)
                # self.l14.setText(self.l14.text()+chash)
                self.l14.setText(self.l14.text())
                cv2.waitKey(0)
    ...
    def clk(self):
        ...
        with open(self.app1[0], 'r') as file_header:
            if self.app1[0] == "":
                ...
                hh = self.pixmap1.scaled(120, 120)
    ...
    def angleplot(self):
        ...
        # self.l14.setText(str(cnc)+self.l14.text())
        # print(len(cnc))
    ...
    def sendmsg(self):
        ...
        if self.rcvrip == "" :
            print("Recipient")
            QMessageBox.about(self, "Warning", "Recipient?")
        else :
            a=self.l23.text()
            # a="ayyyyo ammme"
            import pyaes
    ...
    def stegano(self):
        ...
        if self.rcvrip == "":
            print("")
            QMessageBox.about(self,"Warning","Choose a Reciever")
        else :
            try:
                a=Db()
